...
<body>
    ...
    <div class="signup-container">
        <div class="signup-card">
            ...
            $first_name_err = $last_name_err = $email_err = $mobile_err = $password_err = $terms_err = $signup_err = "";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($first_name_err) && empty($last_name_err) && empty($email_err) && empty($mobile_err) && empty($password_err) && empty($terms_err)) {
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($last_name_err)) { echo '<div class="error-text">' . $last_name_err . '</div>'; } ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($mobile_err)) { echo '<div class="error-text">' . $mobile_err . '</div>'; } ?>
                </div>
                ...
                <div class="terms-checkbox">
                    ...
                    <?php if (!empty($terms_err)) { echo '<div class="error-text">' . $terms_err . '</div>'; } ?>
                </div>
